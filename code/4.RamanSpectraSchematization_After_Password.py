...
# Raman Peak Table 검색
# Pubmed 링크 버튼
# 비밀번호 기능 - 무료구간 500~800 / 유료구간 900~3500

# (+) Tab3 - 비밀번호 기능 문제 해결 - 비밀번호 칸에 한 번 입력해두면 계속 모든 구간 검색 가능
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.lineEdit_4, 0, 5, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "PW"))
...
## tab3 - Peak Table 출력, 비밀번호 생성(무료:400~800)
    def filter_raman_peaks(self):
        ...
        #if 400 <= start_val <= 800 and 400 <= end_val <= 800 and pwd == '':
        if 400 <= start_val <= 800 and 400 <= end_val <= 800:
            ...
            if pwd == "1234":
                ...
                # 비밀번호 불일치 시 출력 메시지
                QtWidgets.QMessageBox.information(self.tab_2, "Paid Subscription Required", "틀린 비밀번호입니다.")
